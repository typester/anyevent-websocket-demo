...
<html>
<head>
<title>AnyEvent Chat demo</title>
...
<h1 class="chat-room-name">Chat room</h1>
...
<div id="footer">Powered by <a href="http://search.cpan.org/dist/AnyEvent">AnyEvent/<?= $AnyEvent::VERSION ?></a>.</div>
